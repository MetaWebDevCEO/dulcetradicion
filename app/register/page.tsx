       ...
       <main className="w-full max-w-md px-6 py-10">
        <div className="mb-8 flex flex-col items-center">
          ...
          <p className="mt-1 text-sm text-[var(--foreground)]/80">
            Regístrate para ordenar tus postres y bebidas favoritas.
          </p>
        </div>
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
           ...
           <div>
             ...
             <div className="relative">
               <span className="pointer-events-none absolute left-4 top-1/2 -translate-y-1/2 text-[var(--foreground)]/70">
                 <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
                   <path
